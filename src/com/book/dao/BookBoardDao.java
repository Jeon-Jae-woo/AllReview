...
public interface BookBoardDao {
	...
	//리뷰 글 조회
	String bookReviewOne = "SELECT REVIEW_ID, REVIEW_TITLE, REVIEW_CONTENT, NICKNAME, BOOK_ID, REVIEW_R_NUM, REVIEW_V_NUM, CREATEAT, REVIEW_IMG FROM BOOK_REVIEW_BOARD WHERE REVIEW_ID=?";
