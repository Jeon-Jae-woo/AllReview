DROP TABLE SHOP_TB CASCADE CONSTRAINTS;
DROP SEQUENCE SHOPSQ;
DROP TABLE SHOP_CATE CASCADE CONSTRAINTS;
DROP TABLE SHOP_GROUP CASCADE CONSTRAINTS;
DROP TABLE SHOP_HIT CASCADE CONSTRAINTS;
DROP TABLE SHOP_RECO CASCADE CONSTRAINTS;
DROP SEQUENCE HITSQ;
DROP SEQUENCE RECOSQ;
...
CREATE TABLE SHOP_TB(
    ...
    RECIPT_IMG VARCHAR2(200) NOT NULL,
    UPLOAD_IMG VARCHAR2(200),
...
CREATE TABLE SHOP_HIT(
	...
	CONSTRAINT SHOP_HITNICK_FK FOREIGN KEY(NICKNAME) REFERENCES MEMBER(NICKNAME),
...
CREATE TABLE SHOP_RECO(
	...
	CONSTRAINT SHOP_RECONICK_FK FOREIGN KEY(NICKNAME) REFERENCES MEMBER(NICKNAME),
...
INSERT INTO SHOP_TB(SHOP_NO,NICKNAME,CATEGORY_NO,GROUP_NO,TITLE,CONTENT,SERVICE,CLEAN,TRAFFIC,REVISIT,HIT,RECO,
RECIPT,STATUS,CREATEAT,UPDATEAT,DELETES,RECIPT_IMG,UPLOAD_IMG) 
VALUES(SHOPSQ.NEXTVAL,'구본익',1,5,'샘플17','샘플내용',1,1,1,'N',0,0,0,1,SYSDATE,SYSDATE,0,'TEST',NULL);
