...
<body>
	...
	<section>
		...
		<input type="checkbox" value="상품만족도"> 상품만족도
		<input type="checkbox" value="기타만족도"> 기타만족도
		<!-- 별점기능 -->
		...
		<!-- 별점기능 -->
		<!-- 내용 -->
		<textarea rows="30" cols="200">내용을 입력하세요.</textarea>
		...
		<!-- 작성 완료 -->
		<button class="wrtbt" onclick="">수정 완료</button>
