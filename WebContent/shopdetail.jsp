        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="검색" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b94e766d706d01e912b37a2fa7e64573&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function removeAllChildNods(el) {   
    while (el.hasChildNodes()) {
		...
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b94e766d706d01e912b37a2fa7e64573"></script>
		<script>
	...
	<tr>
		...
		<td>
		<input type="button" value="추천" onclick="location.href='shop.do?command=reco&shopno=${dto.shopno}'">
		추천수 : ${dto.reco }
		</td>
	</tr>
